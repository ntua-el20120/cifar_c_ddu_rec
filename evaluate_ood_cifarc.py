...
import data.ood_detection.cifar10c as cifar10c
...
# Dataset params
dataset_num_classes = {"cifar10": 10, "cifar100": 100, "svhn": 10, "cifar10c": 10}

dataset_loader = {"cifar10": cifar10, "cifar100": cifar100, "svhn": svhn, "cifar10c": cifar10c}
    ...
    if args.ood_dataset == "cifar10c":
        for severity in range(1, 6):
            for corruption in ['brightness', 'contrast', 'defocus_blur', 'elastic_transform', 'fog', 'frost', 'gaussian_blur', 'gaussian_noise', 'glass_blur', 'impulse_noise', 'jpeg_compression', 'motion_blur', 'pixelate', 'saturate', 'shot_noise', 'snow', 'spatter', 'speckle_noise', 'zoom_blur']:
                print(f"Evaluating {args.dataset} with {args.ood_dataset} for severity {severity} and corruption {corruption}")
                test_loader = dataset_loader[args.dataset].get_test_loader(batch_size=args.batch_size, pin_memory=args.gpu)

                ood_test_loader = cifar10c.get_cifar10_c_loader(
                ...
                def convert_to_json_serializable(obj):
                    ...
                    if isinstance(obj, dict):
                    ...
                    elif type(obj).__module__ == 'torch' and hasattr(obj, 'item'):
                        return obj.item()
                        ...
                        return str(obj)  # fallback, convert unknowns to string


                res_dict = convert_to_json_serializable(res_dict)
